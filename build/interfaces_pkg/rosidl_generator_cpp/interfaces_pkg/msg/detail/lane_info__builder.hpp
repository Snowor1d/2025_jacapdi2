...
{
public:
  explicit Init_LaneInfo_slope(::interfaces_pkg::msg::LaneInfo & msg)
  : msg_(msg)
  {}
...
class Init_LaneInfo_lane_id
{
public:
  Init_LaneInfo_lane_id()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_LaneInfo_slope lane_id(::interfaces_pkg::msg::LaneInfo::_lane_id_type arg)
  {
    msg_.lane_id = std::move(arg);
    return Init_LaneInfo_slope(msg_);
  }
...
{
  return interfaces_pkg::msg::builder::Init_LaneInfo_lane_id();
}
