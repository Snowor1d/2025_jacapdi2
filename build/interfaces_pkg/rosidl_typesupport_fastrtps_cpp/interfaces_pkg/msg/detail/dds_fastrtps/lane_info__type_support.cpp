...
{
bool cdr_serialize(
  const interfaces_pkg::msg::TargetPoint &,
  ...
  interfaces_pkg::msg::LaneInfo & ros_message)
{
  ...
  // Member: target_points
  {
    ...
    ros_message.target_points.resize(size);
    for (size_t i = 0; i < size; i++) {
      interfaces_pkg::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.target_points[i]);
    }
  }
  ...
  // Member: target_points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.target_points[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: target_points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces_pkg::msg::typesupport_fastrtps_cpp::max_serialized_size_TargetPoint(
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg::msg::LaneInfo;
    is_plain =
      (
