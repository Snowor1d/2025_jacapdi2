...
class Metaclass_LaneInfo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if TargetPoint.__class__._TYPE_SUPPORT is None:
                TargetPoint.__class__.__import_type_support__()
...
class LaneInfo(metaclass=Metaclass_LaneInfo):
    ...
    _fields_and_field_types = {
        'lane_id': 'string',
        'slope': 'float',
        'target_points': 'sequence<interfaces_pkg/TargetPoint>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.BasicType('float'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['interfaces_pkg', 'msg'], 'TargetPoint')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, TargetPoint) for v in value) and
                 True), \
                "The 'target_points' field must be a set or sequence and each value of type 'TargetPoint'"
