...
#include "interfaces_pkg/msg/detail/target_point__functions.h"  // target_points
#include "rosidl_runtime_c/string.h"  // lane_id
#include "rosidl_runtime_c/string_functions.h"  // lane_id

// forward declare type support functions
size_t get_serialized_size_interfaces_pkg__msg__TargetPoint(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_interfaces_pkg__msg__TargetPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_pkg, msg, TargetPoint)();
  ...
  // Field name: target_points
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces_pkg, msg, TargetPoint
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: target_points
  {
    ...
    if (ros_message->target_points.data) {
      interfaces_pkg__msg__TargetPoint__Sequence__fini(&ros_message->target_points);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name target_points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_interfaces_pkg__msg__TargetPoint(
  ...
  size_t current_alignment)
{
  ...
  // member: target_points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_interfaces_pkg__msg__TargetPoint(
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg__msg__LaneInfo;
    is_plain =
      (
      offsetof(DataType, target_points) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _LaneInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces_pkg__msg__LaneInfo(
