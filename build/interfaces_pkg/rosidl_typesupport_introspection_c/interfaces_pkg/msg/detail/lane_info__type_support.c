...
static rosidl_typesupport_introspection_c__MessageMember interfaces_pkg__msg__LaneInfo__rosidl_typesupport_introspection_c__LaneInfo_message_member_array[3] = {
  {
    "lane_id",  // name
    ...
    offsetof(interfaces_pkg__msg__LaneInfo, lane_id),  // bytes offset in struct
    NULL,  // default value
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces_pkg, msg, LaneInfo)() {
  interfaces_pkg__msg__LaneInfo__rosidl_typesupport_introspection_c__LaneInfo_message_member_array[2].members_ =
