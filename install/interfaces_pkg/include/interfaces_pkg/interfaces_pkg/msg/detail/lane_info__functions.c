...
interfaces_pkg__msg__LaneInfo__init(interfaces_pkg__msg__LaneInfo * msg)
{
  ...
  // slope
  // target_points
  if (!interfaces_pkg__msg__TargetPoint__Sequence__init(&msg->target_points, 0)) {
    interfaces_pkg__msg__LaneInfo__fini(msg);
    return false;
  }
  return true;
...
interfaces_pkg__msg__LaneInfo__fini(interfaces_pkg__msg__LaneInfo * msg)
{
  ...
  // slope
  // target_points
  interfaces_pkg__msg__TargetPoint__Sequence__fini(&msg->target_points);
}
...
interfaces_pkg__msg__LaneInfo__are_equal(const interfaces_pkg__msg__LaneInfo * lhs, const interfaces_pkg__msg__LaneInfo * rhs)
{
  ...
  // target_points
  if (!interfaces_pkg__msg__TargetPoint__Sequence__are_equal(
  ...
  interfaces_pkg__msg__LaneInfo * output)
{
  ...
  // target_points
  if (!interfaces_pkg__msg__TargetPoint__Sequence__copy(
...
interfaces_pkg__msg__LaneInfo__create()
{
  ...
  interfaces_pkg__msg__LaneInfo * msg = (interfaces_pkg__msg__LaneInfo *)allocator.allocate(sizeof(interfaces_pkg__msg__LaneInfo), allocator.state);
  if (!msg) {
    return NULL;
  }
...
interfaces_pkg__msg__LaneInfo__Sequence__init(interfaces_pkg__msg__LaneInfo__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interfaces_pkg__msg__LaneInfo *)allocator.zero_allocate(size, sizeof(interfaces_pkg__msg__LaneInfo), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces_pkg__msg__LaneInfo__Sequence * array = (interfaces_pkg__msg__LaneInfo__Sequence *)allocator.allocate(sizeof(interfaces_pkg__msg__LaneInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  interfaces_pkg__msg__LaneInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interfaces_pkg__msg__LaneInfo * data =
      (interfaces_pkg__msg__LaneInfo *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces_pkg__msg__LaneInfo__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces_pkg__msg__LaneInfo__fini(&output->data[i]);
        }
        return false;
      }
    }
